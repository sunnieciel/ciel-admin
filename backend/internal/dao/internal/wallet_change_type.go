...
// WalletChangeTypeColumns defines and stores column names for table w_wallet_change_type.
...
// walletChangeTypeColumns holds the columns for table w_wallet_change_type.
