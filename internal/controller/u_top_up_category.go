// =================================================================================
// This is auto-generated by Freekey Admin at 2022-09-05 07:02:32. For more information see https://github.com/1211ciel/ciel-admin
// =================================================================================
...
type cTopUpCategory struct{ cBase }

var TopUpCategory = cTopUpCategory{cBase{"u_top_up_category", "/admin/topUpCategory", "/settings/topUpCategory"}}

func (c cTopUpCategory) Index(r *ghttp.Request) {
	var (
		ctx     = r.Context()
		reqPath = r.URL.Path
...
func (c cTopUpCategory) AddIndex(r *ghttp.Request) {
	res.Tpl(fmt.Sprint(c.FileDir, "/add.html"), g.Map{"msg": sys.MsgFromSession(r)}, r)
}
func (c cTopUpCategory) EditIndex(r *ghttp.Request) {
	var (
		table = c.Table
		id    = r.Get("id").Uint64()
...
func (c cTopUpCategory) Post(r *ghttp.Request) {
	var (
		d = entity.TopUpCategory{}
	)
...
func (c cTopUpCategory) Del(r *ghttp.Request) {
	var (
		id    = r.Get("id")
		table = c.Table
	)
...
func (c cTopUpCategory) Put(r *ghttp.Request) {
	var (
		d     = entity.TopUpCategory{}
		table = c.Table
	)
...
func (c cTopUpCategory) RegisterRouter(g *ghttp.RouterGroup) {
	g.Group("/topUpCategory", func(g *ghttp.RouterGroup) {
